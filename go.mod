module github.com/tanaka-takurou/serverless-application-management-page-go
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/serverlessapplicationrepository v1.1.1 // indirect
)
